...
const { get_inventory, make_order} = require("./cj_product_controller")
...
router.post("/make_order", isAuthenticated, make_order)
router.post("/get_inventory", isAuthenticated, get_inventory)
