    ...
    <Fragment>
        <a href="/cart" className='flex flex-col  sm:ml-2 items-center'>
            ...
            <img width={5} height={5} className="w-[24px] h-[24px]" alt="კალათა" src={Cart}></img>       
                {localStorage.getItem("c") && <span className='absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 flex items-center justify-center rounded-full bg-[rgb(251,77,1)] p-[6px] text-xs text-white'></span>}  
            </div>           
