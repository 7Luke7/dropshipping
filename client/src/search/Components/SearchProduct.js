...
export const SearchProduct = ({p}) => {
  const [isLoading, setIsLoading] = useState(true)
    ...
    return <section className="xxs:w-[220px] lg:w-[200px] xs:w-[230px] mobl:w-[160px] xl:w-[200px] transition-transform duration-100 ease-out transform hover:scale-[1.01]">
      <a href={`/product/${p.id}`}>
        ...
        <article itemScope itemType="https://schema.org/Product">
          ...
          <h1
            className="xxs:text-xl xs:text-sm text-gray-800 font-bold mobl:text-sm"
            itemProp="name"
          >
